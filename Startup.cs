...
namespace Assignment5.LibraryWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddTransient<IStudentInfoRepository, InMemoryStudentRepository>()
                .AddTransient<IBookInfoRepository, InMemoryBookRepository>()
                .AddTransient<IBookIssueRepository, InMemoryBookIssueRepository>()
                .AddTransient<ILibraryServiceForStudents, StudentLibraryService>()
